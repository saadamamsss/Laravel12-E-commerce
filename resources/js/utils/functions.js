export const saad_google_maps = function ($) {
...
export const saad = function ($) {
    if (document.querySelectorAll(".cardcontent .col-lg-12").length > 0) {
        var width =
            document.querySelectorAll(".cardcontent .sa")[0].clientWidth;

        console.log(width);

        //document.querySelector('.content .col-lg-12 .checked span');
...
export const mercado_product_slider = function ($) {
...
export const mercado_chosen = function ($) {
...
export const mercado_toggle_slide_menu = function ($) {
...
export const mercado_price_range = function ($) {
...
export const mercado_clone_all_zan_menus = function ($) {
    var i = 0,
...
export const mercado_insert_children_panels_html_by_elem = function (
    $,
    $elem,
    i
) {
...
export const mercado_control_panel = function ($) {
...
export const mercado_control_mobile_menu = function ($) {
    // BOX MOBILE MENU
...
export const mercado_innit_carousel = function ($) {
...
export const mercado_tabs = function ($) {
...
export const mercado_countdown = function ($) {
...
export const mercado_better_equal_elems = function ($) {
    setTimeout(function () {
...
export const mercado_price_quantity = function ($) {
    if ($(".quantity-input").length > 0) {
        $(".quantity-input").on("click", ".q-btn", function (event) {
            event.preventDefault();
...
export const mercado_remove_product_in_cart = function ($) {
...
export const mercado_toggle_vertical_main_menu = function ($) {
...
export const mercado_sticky_menu = function ($) {
    ...
    if (parseInt(_device_size, 10) > 1024 && $(".header-sticky").length > 0) {
        ...
        var header_height = $(".header").innerHeight(),
            ...
            _topSpacing = 0,
            header_sticky = $("body .header-sticky"),
...
export const mercado_google_maps = function ($) {
    if ($(".mercado-google-maps").length == 1) {
